...
@Component({
    ...
    <div class="page-hero">
      ...
      <div class="container" style="position:relative;z-index:2">
        <div class="ph-inner">
          ...
          <p class="ph-desc">
            Custom software, web &amp; mobile applications, AI automation, hotel
            technology, cloud infrastructure and business platforms — built around
  ...
  styles: [`
    ...
    .ph-desc {
      ...
      line-height: 1.8; max-width: 560px; margin: 0 auto 24px;
    }
    .ph-breadcrumb {
